...
class GoalMetricsManager: ObservableObject {
    ...
    private func loadMetrics() {
        // Default metrics
        let defaultMetrics = [
            GoalMetric(type: .protein, isSelected: true),
            GoalMetric(type: .steps, isSelected: true),
            GoalMetric(type: .nova4, isSelected: true),
            GoalMetric(type: .calories, isSelected: false),
            GoalMetric(type: .carbs, isSelected: false),
            GoalMetric(type: .fat, isSelected: false),
            GoalMetric(type: .water, isSelected: false),
            GoalMetric(type: .sleep, isSelected: false)
        ]
