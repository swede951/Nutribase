            ...
            VStack(spacing: 16) {
                ...
                ZStack {
                    ...
                    if supabaseService.currentUser != nil {
                        Text(String(supabaseService.currentUser?.email.prefix(1).uppercased() ?? ""))
                ...
                Text(supabaseService.currentUser?.email ?? "Guest User")
                    .font(.title2)
                    .fontWeight(.semibold)
            ...
            VStack(spacing: 0) {
                ...
                if supabaseService.isAuthenticated {
                    ...
                    ProfileOptionRow(icon: "arrow.right.square", title: "Log In", textColor: .blue, action: {
                        // Clear guest mode and go back to login screen
